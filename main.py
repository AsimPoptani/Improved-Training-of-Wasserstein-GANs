...
class ImprovedWassersteinGAN(L.LightningModule):
    ...
    def configure_optimizers(self) -> OptimizerLRScheduler:
        gan_optimizer = torch.optim.SGD(self.generator.parameters(), lr=1e-4, momentum=1e-3)
        dis_optimizer = torch.optim.SGD(self.discriminator.parameters(), lr=1e-4, momentum=1e-3)
